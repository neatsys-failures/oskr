...
\item 
virtual void \mbox{\hyperlink{classoscar_1_1Transport_acd5e8804ec663f74387ad2eb167d8d60}{send\+Message}} (const \mbox{\hyperlink{classoscar_1_1TransportReceiver}{Transport\+Receiver}}$<$ Self $>$ \&sender, const \mbox{\hyperlink{classoscar_1_1Transport_aff91396b76146595e391b69f5e22b93e}{Address}} \&dest, \mbox{\hyperlink{classoscar_1_1Transport_a6a11e02eceec229ca9da406625e319a7}{Write}} write)=0
\item 
...
\index{oscar::Transport$<$ Self $>$@{oscar::Transport$<$ Self $>$}!sendMessage@{sendMessage}}
\index{sendMessage@{sendMessage}!oscar::Transport$<$ Self $>$@{oscar::Transport$<$ Self $>$}}
\doxysubsubsection{\texorpdfstring{sendMessage()}{sendMessage()}}
{\footnotesize\ttfamily template$<$typename Self $>$ \\
virtual void \mbox{\hyperlink{classoscar_1_1Transport}{oscar\+::\+Transport}}$<$ Self $>$\+::send\+Message (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classoscar_1_1TransportReceiver}{Transport\+Receiver}}$<$ Self $>$ \&}]{sender,  }\item[{const \mbox{\hyperlink{classoscar_1_1Transport_aff91396b76146595e391b69f5e22b93e}{Address}} \&}]{dest,  }\item[{\mbox{\hyperlink{classoscar_1_1Transport_a6a11e02eceec229ca9da406625e319a7}{Write}}}]{write }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [pure virtual]}}
...
Implemented in \mbox{\hyperlink{classoscar_1_1SimulatedTransport_a0fe3c3e0b49912abccafa0ec74115125}{oscar\+::\+Simulated\+Transport}}.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{140     \{}
\DoxyCodeLine{141         \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} address : \mbox{\hyperlink{classoscar_1_1Transport_a8b9ecf7c01c870e14abadf0c252b4a7e}{config}}.replica\_address\_list) \{}
\DoxyCodeLine{142             \textcolor{keywordflow}{if} (address != sender.address) \{}
\DoxyCodeLine{143                 \mbox{\hyperlink{classoscar_1_1Transport_acd5e8804ec663f74387ad2eb167d8d60}{sendMessage}}(sender, address, write);}
\DoxyCodeLine{144             \}}
\DoxyCodeLine{145         \}}
\DoxyCodeLine{146     \}}
